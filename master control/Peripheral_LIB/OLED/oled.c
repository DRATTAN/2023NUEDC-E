...
//
//static void inttostr(char *taddr, int32_t data, uint8_t minlength)
//{
//    int32_t _data;
//    uint8_t buffer[12];
//    uint8_t counter = 0;
//    buffer[11] = '\0';
//    if(minlength > 11) minlength = 11;
//    memset(taddr, ' ', minlength);
//    memset(taddr + minlength, '\0', 1);
//    if(data < 0) _data = -1 * data;
//    else _data = data;
//    for(; ((_data != 0) && (counter <= 9)) || ((_data == 0) && (counter == 0)); counter++)
//    {
//        buffer[10 - counter] = (_data % 10) + '0';
//        _data /= 10;
//    }
//    if(data < 0)
//    {
...
//        counter++;
//    }
//    if(counter >= minlength) memcpy(taddr, buffer + 11 - counter, counter + 1);
//    else memcpy(taddr, buffer + 11 - counter, counter);
//}
//
//static void uinttostr(char *taddr, uint32_t data, uint8_t minlength)
//{
//    uint8_t buffer[12];
//    uint8_t counter = 0;
//    buffer[11] = '\0';
...
//    memset(taddr, ' ', minlength);
//    memset(taddr + minlength, '\0', 1);
//    for(; ((data != 0) && (counter <= 9)) || ((data == 0) && (counter == 0)); counter++)
//    {
//        buffer[10 - counter] = (data % 10) + '0';
//        data /= 10;
//    }
//    if(counter >= minlength) memcpy(taddr, buffer + 11 - counter, counter + 1);
//    else memcpy(taddr, buffer + 11 - counter, counter);
//}
//
//static void floattostr(uint8_t *taddr, float data, uint8_t mlength)
//{
//}
//
...
{
    delay_ms(100);
//    Oled_Cmd(0xAE); Oled_Cmd(0x20); Oled_Cmd(0x10); Oled_Cmd(0x40); Oled_Cmd(0x81); Oled_Cmd(0xcf); Oled_Cmd(0xa1);
