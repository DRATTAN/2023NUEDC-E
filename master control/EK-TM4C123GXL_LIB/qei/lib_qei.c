...
void LIB_QEI_Init(uint8_t QEI_Num, uint32_t Freq, void (*QEIx_ISRhandle)(void))
{
    ...
    case QEI0:
        ...
        GPIOPadConfigSet(GPIO_PORTD_BASE, GPIO_PIN_6 | GPIO_PIN_7, GPIO_STRENGTH_4MA, GPIO_PIN_TYPE_STD_WPD);
        break;
    case QEI1:
        ...
        GPIOPadConfigSet(GPIO_PORTC_BASE, GPIO_PIN_5 | GPIO_PIN_6, GPIO_STRENGTH_4MA, GPIO_PIN_TYPE_STD_WPD);
        break;
    default:
        break;
 ...
 */
inline uint32_t LIB_QEI_GetPulse(uint8_t QEI_Num)
{
 ...
 */
inline int8_t LIB_QEI_GetDirect(uint8_t QEI_Num)
{
 ...
 */
inline uint32_t LIB_QEI_GetPos(uint8_t QEI_Num)
{
 ...
 * 备注:None
 */
inline void LIB_QEI_SetPos(uint8_t QEI_Num,uint32_t Pos)
{
